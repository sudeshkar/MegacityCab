...
<table border="1">
    ...
    <tr>
        ...
        <td>
            <form action="<%= request.getContextPath() %>/TrackBooking" method="POST" style="display:inline;">
                <input type="hidden" name="bookingID" value="<%= booking.getBookingNumber() %>">
                <button type="submit" onclick="return confirm('Are you sure you want to END this booking?');">End Booking</button>
            </form>
        </td>
    </tr>
    <%
